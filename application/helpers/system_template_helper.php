...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url()?>assets/images/Logo/official-logo.png">
  ...
  <link rel="icon" href="<?php echo base_url()?>assets/images/Logo/official-logo.png">
  ...
  <div id="aside" class="app-aside modal fade nav-dropdown">
    ...
    <div class="left navside light-green-400 dk" layout="column">
        ...
        <a class="navbar-brand">
          <img src="<?php echo base_url()?>assets/images/Logo/official-logo.png" alt=".">        
        	<span class="hidden-folded inline text-muted"><?=SYSTEM_ALT?></span>
        </a>
        <!-- / brand -->
      </div>
